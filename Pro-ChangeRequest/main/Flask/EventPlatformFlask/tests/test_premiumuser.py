...
def test_case_12_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole):
    with current_app.test_request_context(
        ...
        # Scenario: a user user2 with PREMIUMUSER role
        ...
        # login
        login_user(user2)
        # Test PREMIUMUSER accessing update_user()
        try:
            result = update_user()
...
def test_case_13_PREMIUMUSER(app, request, user1, freeuserrole, user2, premiumuserrole, adminrole):
    with current_app.test_request_context(
        data={ "id": user1.id, 
              "name": user1.name,
              "surname": user1.surname,
...
# On line 118 of the description: Users can see any other user�s core information (name, surname, username, and role).
def test_case_14_PREMIUMUSER(app, request, user1, premiumuserrole):
    with current_app.test_request_context():
        ...
        # login
        login_user(user1)
        # Test PREMIUMUSER accessing user()
        result = user(user1.id)
        assert result.get("user").username == user1.username

def test_case_14_FREEUSER_1(app, request, user1, user2, freeuserrole, premiumuserrole):
    with current_app.test_request_context():
        # Scenario: person user1 with PREMIUMUSER role
        #                  user2 with FREEUSER role
        user1.role = premiumuserrole
        db.session.add(user1)
...
def test_case_16_PREMIUMUSER(app, request, user1, premiumuserrole):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        user1.role = premiumuserrole
        db.session.add(user1)
        ...
        # Test PREMIUMUSER accessing user()
        result = user(user1.id)
        assert result.get("user").role.name == premiumuserrole.name

def test_case_16_FREEUSER_1(app, request, user1, user2, freeuserrole, premiumuserrole):
    with current_app.test_request_context():
        # Scenario: person user1 with PREMIUMUSER role, user2 with FREEUSER role
        user1.role = premiumuserrole
        db.session.add(user1)
        user2.role = freeuserrole
        db.session.add(user2)
...
def test_case_18_PREMIUMUSER(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
...
def test_case_18_PREMIUMUSER_1(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
def test_case_19_PREMIUMUSER(app, request, user1, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
...
# Testing /events
def test_case_20_PREMIUMUSER(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
# Testing /profile
def test_case_20_PREMIUMUSER_1(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a PREMIUMUSER user1, 
...
# Testing /view_event
def test_case_20_PREMIUMUSER_2(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
# Test edit_event
def test_case_20_PREMIUMUSER_3(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
# Test view_category
def test_case_20_PREMIUMUSER_4(app, request, user1, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a category category1
        #           a public event owned by user1, of category1
...
def test_case_21_PREMIUMUSER(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
...
def test_case_21_PREMIUMUSER_1(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
...
# Testing /profile
def test_case_21_PREMIUMUSER_2(app, request, user1, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
...
# Testing /view_event
def test_case_21_PREMIUMUSER_3(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
def test_case_21_PREMIUMUSER_4(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
...
# Test edit_event
def test_case_21_PREMIUMUSER_5(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
def test_case_21_PREMIUMUSER_6(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2, attended by user2
...
# Test view_category
def test_case_21_PREMIUMUSER_7(app, request, user1, user2, premiumuserrole, privateevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a category category1
...
def test_case_21_PREMIUMUSER_8(app, request, user1, user2, premiumuserrole, privateevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a category category1
...
# Testing /view_event
def test_case_22_PREMIUMUSER(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
# Test edit_event
def test_case_22_PREMIUMUSER_1(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
# Testing /view_event
def test_case_23_PREMIUMUSER(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
def test_case_23_PREMIUMUSER_1(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2, attended by user1
...
# Test edit_event
def test_case_23_PREMIUMUSER_2(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
def test_case_23_PREMIUMUSER_3(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2, attended by user1
...
# Test \events
def test_case_24_PREMIUMUSER(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
# Test profile
def test_case_24_PREMIUMUSER_1(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a PREMIUMUSER user1, 
        #           a publicevent of user1
        user1.role = premiumuserrole
...
# Test \view_category
def test_case_24_PREMIUMUSER_2(app, request, user1, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a category category1
        #           a public event owned by user1, of category1
...
# Test \events
def test_case_25_PREMIUMUSER(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
def test_case_25_PREMIUMUSER_1(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2, attended by user1
...
# Test view_category
def test_case_25_PREMIUMUSER_2(app, request, user1, user2, premiumuserrole, privateevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a category category1
...
def test_case_25_PREMIUMUSER_3(app, request, user1, user2, premiumuserrole, privateevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a category category1
...
# Test \events
def test_case_26_PREMIUMUSER(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context():
...
# Test \profile:
def test_case_26_PREMIUMUSER_1(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context():
        # Scenario: a PREMIUMUSER user1
        #           a category category1
        user1.role = premiumuserrole
...
def test_case_26_PREMIUMUSER_1(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context():
        # Scenario: a category category1, a PREMIUMUSER user1
        user1.role = premiumuserrole
        db.session.add(user1)
        db.session.add(category1)
        db.session.commit()
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing categories()
        result = categories()
        assert len(result.get("categories")) == 1
        assert result.get("categories")[0].name == category1.name

# Testing /view_event
def test_case_26_PREMIUMUSER_2(app, request, user1, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a category category1
        #           a public event owned by user1, of category1
...
# Testing /view_event
def test_case_26_PREMIUMUSER_3(app, request, user1, user2, premiumuserrole, privateevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a category category1
...
# Test edit_event
def test_case_26_PREMIUMUSER_4(app, request, user1, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a category category1
        #           a public event owned by user1, of category1
...
# Test edit_event
def test_case_26_PREMIUMUSER_5(app, request, user1, user2, premiumuserrole, privateevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a category category1
...
# Test /user
def test_case_26_PREMIUMUSER_8(app, request, user1, premiumuserrole, user2, moderatorrole, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
...
# Test view_category
def test_case_26_PREMIUMUSER_6(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context():
        # Scenario: a category category1 and a PREMIUMUSER user1
        user1.role = premiumuserrole
        db.session.add(user1)      
        db.session.add(category1)
        db.session.commit()
...
# Test edit_category
def test_case_26_PREMIUMUSER_7(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context():
        # Scenario: a category category1 and a PREMIUMUSER user1
        user1.role = premiumuserrole
        db.session.add(user1)      
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing edit_category()
        try:
...
# Test edit_category
def test_case_27_PREMIUMUSER(app, request, user1, premiumuserrole, user2, moderatorrole, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with MODERATOR role.
        #           a category category1
...
# Test \categories
def test_case_28_PREMIUMUSER(app, request, user1, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a category category1
        #           a public event owned by user1, of category1
...
# Test view_category
def test_case_28_PREMIUMUSER_1(app, request, user1, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a category category1
        #           a public event owned by user1, of category1
...
def test_case_29_PREMIUMUSER(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context(
...
# Testing /events
def test_case_30_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 PREMIUMUSER role, user2 with FREEUSER role.
...
# Test view_event
def test_case_30_PREMIUMUSER_1(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a public event owned by user2
        user1.role = premiumuserrole
...
# Test edit_event
def test_case_30_PREMIUMUSER_2(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a public event owned by user2
        user1.role = premiumuserrole
...
# Test view_category
def test_case_30_PREMIUMUSER_3(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a category category1
        #           a public event owned by user2, of category1
...
# Testing /events
def test_case_31_PREMIUMUSER(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
# Test view_event
def test_case_31_PREMIUMUSER_1(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
# Test edit_event
def test_case_31_PREMIUMUSER_2(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
# Test view_category
def test_case_31_PREMIUMUSER_3(app, request, user1, 
...
# Test view_event
def test_case_32_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1, user2 with PREMIUMUSER role.
        #           a public event owned by user2
        user1.role = premiumuserrole
        db.session.add(user1)
        user2.role = freeuserrole
...
# Test manage_event
def test_case_32_PREMIUMUSER_1(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1, user2 with PREMIUMUSER role.
        #           a public event owned by user2
        user1.role = premiumuserrole
...
# Test view_event
def test_case_33_PREMIUMUSER(app, request, user1, premiumuserrole,
                         user2, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
...
# Test manage_event
def test_case_33_PREMIUMUSER_1(app, request, user1, premiumuserrole,
                         user2, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
...
# Test view_event
def test_case_34_PREMIUMUSER(app, request, user1, premiumuserrole,
                         user2, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
...
def test_case_35_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context(
        data={ "id": publicevent1.id, 
              "title": "new title", 
              "description": "new description", 
              "categories": publicevent1.categories}):
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing update_event()
        result = update_event()
...
def test_case_36_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context(
        data={ "id": publicevent1.id, 
              "title": "new title", 
              "description": "new description", 
...
def test_case_36_PREMIUMUSER_1(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context(
        data={ "id": publicevent1.id, 
              "title": "new title", 
              "description": "new description", 
...
def test_case_38_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing promote_manager()
...
def test_case_39_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing demote_manager()
...
def test_case_40_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
...
def test_case_40_PREMIUMUSER_1(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
        #           a public event owned by user3, managed by user2
...
def test_case_40_FREEUSER_2(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
        #           a public event owned by user3, managed by user2
...
def test_case_41_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing accept_request()
...
def test_case_42_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
...
def test_case_43_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
        #           a public event owned by user3, 
        #           request to join by user2
...
def test_case_43_PREMIUMUSER_1(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
        #           a public event owned by user3, 
        #           request to join by user2
...
def test_case_44_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a public event owned by user2,
        #           attended by user1
...
def test_case_44_PREMIUMUSER_1(app, request, user1, user2, premiumuserrole, freeuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a public event owned by user2,
        #           NOT attended by user1
...
def test_case_45_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a public event owned by user1, request to join by user2
        user1.role = premiumuserrole
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing reject_request()
        result = reject_request(user2.id, publicevent1.id)
        assert user2.id not in [m.id for m in publicevent1.attendants]
        assert user2.id not in [m.id for m in publicevent1.requesters]

#Test Case	46	Reject request to join manager
def test_case_46_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
        #           a public event owned by user3, 
        #           request to join by user2
...
#def test_case_47_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
#    with current_app.test_request_context():
#        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
#        #           a public event owned by user2,
#        #           attended by user1
...
#        # Log in with user1
#        login_user(user1)
#        # Test PREMIUMUSER accessing leave()
#        result = leave(publicevent1.id)
#        assert user1.id not in [m.id for m in publicevent1.attendants]

#def test_case_47_PREMIUMUSER_1(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
#    with current_app.test_request_context():
#        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
#        #           a public event owned by user2,
#        #           attended by user1
...
#        # Log in with user1
#        login_user(user1)
#        # Test PREMIUMUSER accessing remove_attendee()
#        result = remove_attendee(user1.id, publicevent1.id)
#        assert user1.id not in [m.id for m in publicevent1.attendants]

##Test Case	48	Remove others from attending an event, manager
def test_case_48_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, 
                             premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
        #           a public event owned by user2,
        #           managed by user1
...
def test_case_49_PREMIUMUSER(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
def test_case_50_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
        #           a public event owned by user2,
...
def test_case_51_PREMIUMUSER(app, request, user1, user2, freeuserrole, 
                             premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a public event owned by user2
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing join()
...
def test_case_52_PREMIUMUSER(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: person user1 with PREMIUMUSER role, 
...
def test_case_53_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
        #           a public event owned by user3, 
        #           request to join by user2
...
#def test_case_54_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
#    with current_app.test_request_context():
#        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
#        #           a public event owned by user2, 
...
# Test /manage_event
def test_case_56_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
...
# Test \users
def test_case_56_PREMIUMUSER_1(app, request, user1, user2, freeuserrole, premiumuserrole):
    with current_app.test_request_context():
        # Scenario: a person user1 PREMIUMUSER role, user2 with FREEUSER role.
        user1.role = premiumuserrole
        db.session.add(user1)
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing users()
        result = users()
...
# Test \user
def test_case_56_PREMIUMUSER_2(app, request, user1, user2, freeuserrole, premiumuserrole):
    with current_app.test_request_context():
        # Scenario: a person user1 PREMIUMUSER role, user2 with FREEUSER role.
        user1.role = premiumuserrole
        db.session.add(user1)
...
# Test edit_category
def test_case_56_PREMIUMUSER_4(app, request, user1, premiumuserrole,
...
# Test /main
def test_case_57_PREMIUMUSER(app, request, user1, premiumuserrole):
    with current_app.test_request_context():
        # Scenario: a PREMIUMUSER user1
        user1.role = premiumuserrole
        db.session.add(user1)
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing main()
        result = main()
        user_dto = result.get("user")
...
# Test /manage_event
def test_case_57_PREMIUMUSER_1(app, request, user1, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
# Test \users
def test_case_57_PREMIUMUSER_1(app, request, user1, premiumuserrole):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        user1.role = premiumuserrole
        db.session.add(user1)
...
# Test \user
def test_case_57_PREMIUMUSER_2(app, request, user1, premiumuserrole):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        user1.role = premiumuserrole
        db.session.add(user1)
...
def test_case_58_PREMIUMUSER(app, request, user1, premiumuserrole):
    with current_app.test_request_context(
        data={"id": user1.id, 
              "name": "newname",
              "surname": "newsurname",
              "role": premiumuserrole.name}):
        # Scenario: a user user1 with PREMIUMUSER role
        user1.role = premiumuserrole
        db.session.add(user1)
        db.session.commit()
        # Log in with user1
...
def test_case_59_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole):
    with current_app.test_request_context(
        data={"id": user2.id, 
              "name": "newname",
              "surname": "newsurname",
...
# Test /profile
def test_case_61_PREMIUMUSER(app, request, user1, freeuserrole, premiumuserrole,
                          user2, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a freeuser PREMIUMUSER user1, FREEUSER user2
        #           a category category1
...
# Test /profile
def test_case_62_PREMIUMUSER(app, request, user1, freeuserrole, premiumuserrole,
                          user2, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: a PREMIUMUSER user1, FREEUSER user2
        #           a category category1
        #           a publicevent of user2, of category1
...
def test_case_63_PREMIUMUSER(app, request, user1, premiumuserrole, adminrole):
    with current_app.test_request_context(
        data={ "id": user1.id, 
              "name": user1.name,
              "surname": user1.surname,
        ...
        try:
            ...
            assert user1.role.name == premiumuserrole.name

#Test Case	64	View requested access
def test_case_64_PREMIUMUSER(app, request, user1, user2, premiumuserrole, freeuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a public event owned by user1, request to join by user2
        user1.role = premiumuserrole
...
def test_case_65_PREMIUMUSER(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
...
def test_case_66_PREMIUMUSER(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context():
        # Scenario: a category category1
        #           a person user1 with PREMIUMUSER role.
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing unsubscribe()
...
def test_case_67_68_PREMIUMUSER(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context():
        # Scenario: a category category1
        #           a person user1 with PREMIUMUSER role.
        user1.role = premiumuserrole
...
def test_case_70_PREMIUMUSER(app, request, user1, user2, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context():
        # Scenario: person user1, user2 with PREMIUMUSER role.
        #           a category category1
        #           a public event owned by user2, of category1
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing remove_category()
        try:
...
def test_case_70_PREMIUMUSER_1(app, request, user1, user2, premiumuserrole, publicevent1, category1):
    with current_app.test_request_context(
        data={ "id": publicevent1.id, 
...
def test_case_74_PREMIUMUSER(app, request, user1, 
                               premiumuserrole, category1, 
                               user2):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
...
def test_case_74_PREMIUMUSER_1(app, request, user1, 
                               category1, 
    ...
    with current_app.test_request_context():
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER access to profile()
        result = profile()
        subs_dto = result.get("subs")
        assert len(subs_dto) == 1
...
#def test_case_77_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole):
#    with current_app.test_request_context(
#        data={ "id": user2.id, 
#              "name": user2.name,
#              "surname": user2.surname,
#              "role": premiumuserrole.name}):
#        # Scenario: a user user1 PREMIUMUSER role, user2 with FREEUSER role
#        user1.role = premiumuserrole
#        db.session.add(user1)
#        user2.role = freeuserrole
#        db.session.add(user2)
...
def test_case_79_PREMIUMUSER(app, request, user1, user2, premiumuserrole, moderatorrole, category1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with MODERATOR role.
        #           a category category1
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing add_moderator()
        try:
...
def test_case_79_PREMIUMUSER(app, request, user1, user2, premiumuserrole, moderatorrole, category1):
    with current_app.test_request_context():
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing remove_moderator()
        try:
...
def test_case_80_PREMIUMUSER(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context(
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing create_category()
        try:
...
def test_case_82_PREMIUMUSER(app, request, user1, premiumuserrole, category1):
    with current_app.test_request_context(
        ...
        # Log in with user1
        login_user(user1)
        # Test PREMIUMUSER accessing update_category()
        try:
...
def test_case_83_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2, user3 with FREEUSER role.
        #           a public event owned by user3
        #           managed by user1
...
def test_case_84_PREMIUMUSER(app, request, user1, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 with PREMIUMUSER role.
        #           a public event owned by user1
        user1.role = premiumuserrole
...
# leave functionality is incorrectly implemented, waive this test
#def test_case_86_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
#    with current_app.test_request_context():
#        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
#        #           a public event owned by user2, managed by user1
#        user1.role = premiumuserrole
...
def test_case_86_PREMIUMUSER_1(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a public event owned by user2, managed by user1
        user1.role = premiumuserrole
...
def test_case_87_PREMIUMUSER(app, request, user1, user2, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 PREMIUMUSER role, user2 with FREEUSER role.
        #           a public event owned by user2, managed by user1
        user1.role = premiumuserrole
...
def test_case_90_PREMIUMUSER(app, request, user1, user2, user3, freeuserrole, premiumuserrole, publicevent1):
    with current_app.test_request_context():
        # Scenario: person user1 premiumuser role, user2, user3 with FREEUSER role.
...
def test_case_91_PREMIUMUSER(app, request, user1, premiumuserrole, user2, freeuserrole, publicevent1, category1):
    with current_app.test_request_context(
        data={ "id": publicevent1.id, 
              "title": publicevent1.title, 
              "description": publicevent1.description, 
...
def test_case_92_PREMIUMUSER(app, request, user1, premiumuserrole, user2, freeuserrole, publicevent1, category1):
    with current_app.test_request_context(
        data={ "id": publicevent1.id, 
              "title": publicevent1.title, 
              "description": publicevent1.description, 
              "categories": []}):
        # Scenario: a person user1 with premiumuser role, user2 with freeuser role
        #           a public event owned by user2
        user1.role = premiumuserrole
        db.session.add(user1)
        user2.role = freeuserrole
...
def test_case_93_PREMIUMUSER(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
def test_case_93_PREMIUMUSER_1(app, request, user1, user2, premiumuserrole, privateevent1):
    with current_app.test_request_context():
        # Scenario: a person user1 with PREMIUMUSER role.
        #           a person user2 with PREMIUMUSER role.
        #           a private event owned by user2
...
def test_case_94_PREMIUMUSER(app, request, user1, user2, premiumuserrole, privateevent1, category1):
    with current_app.test_request_context():
        # Scenario: a person user1, user2 with PREMIUMUSER role.
        #           a category category1
        #           a private event owned by user2, of category1
        user1.role = premiumuserrole
        db.session.add(user1)
